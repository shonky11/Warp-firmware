...
typedef enum
{
	...
	kWarpSensorOutputRegisterINA219_SHUNT_V				= 0x01,
	kWarpSensorOutputRegisterINA219_BUS_V				= 0x02,
	kWarpSensorOutputRegisterINA219_POW				= 0x03,
	kWarpSensorOutputRegisterINA219_CURR				= 0x04,
